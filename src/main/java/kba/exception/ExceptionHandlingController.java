...
public class ExceptionHandlingController {
    ...
    public ResponseEntity<ErrorInfo> handleJsonParsingException(HttpServletRequest req, HttpMessageNotReadableException ex) {
        LOG.error("[KATA BANK] Request: {} raised error: {}", req.getRequestURL(), ex.getMessage());
        return new ResponseEntity<>(new ErrorInfo(req.getRequestURL(), "Unable to parse json data, please check the format", ex), HttpStatus.BAD_REQUEST);
    }
